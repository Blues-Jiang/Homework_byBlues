...
scoreTextList = {0:"0~59",60:"60~69",70:"70~79",80:"80~89",90:"90~99",100:"100",-1:"Error"} # the text of every range
...
def GUI():#creat the GUI of this chart.
    ...
    for x in listIndex:
        ...
        temp.setFill('gray')
        temp.draw(win)
        Text(Point(temp.getCenter().getX(),tempP2.getY()+1),subScoreList[x]).draw(win)#draw the number of each range
        tempP1.move(8,0)
